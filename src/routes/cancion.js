...
router.post('/',
            ...
            [body('title').isString().withMessage('El título debe ser una cadena de caracteres.'),
                  body('album').optional().isString().withMessage('El album debe ser una cadena de caracteres.'),
                  body('artist').optional().isString().withMessage('El artista debe ser una cadena de caracteres.'),
                  body('year').optional().isInt().withMessage('La fecha debe ser de tipo Integer.')],
...
router.put('/:id',
            ...
            body('album').optional().isString().withMessage('El album debe ser una cadena de caracteres.'),
            body('artist').optional().isString().withMessage('El artista debe ser una cadena de caracteres.'),
            body('year').optional().isInt().withMessage('La fecha debe ser de tipo Fecha.')],
            validar,
